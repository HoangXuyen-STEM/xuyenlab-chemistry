 ...
 * unlike the decorative `[BẢN NHÁP PILOT]` banner in PilotLessonShell
 * (`aria-hidden`, hidden in print), this is a real accessible landmark that
 * must survive every rendering context. See
