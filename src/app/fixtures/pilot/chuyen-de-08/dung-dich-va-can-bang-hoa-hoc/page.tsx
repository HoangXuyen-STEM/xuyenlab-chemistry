...
// YAML frontmatter removed (`tail -n +17`); the frontmatter block itself
// does not parse cleanly through this project's MDX pipeline (no
...
const TOPIC_TITLE = "Chuyên đề 8 · Dung dịch và cân bằng hóa học";
const LESSON_TITLE = "Dung dịch và cân bằng hóa học — bản nháp pilot Phần I";
const SUMMARY =
  "Bản nháp pilot Phần I; mọi công thức, bảng và hình vẫn chờ Chủ dự án QA.";
const ARTICLE_ID = "dung-dich-va-can-bang-hoa-hoc-body";

export default function PilotDungDichVaCanBangHoaHocPage() {
  const manifest = getPilotLessonManifest(
    "chuyen-de-08",
