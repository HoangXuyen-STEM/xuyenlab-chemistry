...
- **Phase 3 Exit Gate Status:** ✅ TECHNICAL BASELINE ACCEPTED; LIVE ACCOUNT/AUTH UAT DEFERRED TO P7
...
Live user verification was not completed, and two implementation gaps were found at
that time:
...
The project owner changed the delivery sequence on 2026-08-12: content pilot work must
not depend on an application account before an account-provisioning mechanism exists.
Therefore P3 is accepted as a technical baseline and **P4 may start** using Vercel
Preview Protection/Share Links plus synthetic sessions. Live account provisioning,
real login UAT, cross-account verification and authenticated PDF download move to P7.
...
3. Perform end-to-end live account/auth/PDF testing in P7 before production launch.
   **Deferred by project-owner sequencing decision; does not block P4.**
...
**Live external behavior remains UNVERIFIED and deferred to P7.** No request has been
made against the real Neon Auth project or R2 bucket from this environment. Before
production launch—not before P4—the project owner and integration owner must demonstrate:
